                                        ...
                                        <div class="details-image-vertical black-slide rounded">
                                            ...
                                            @if ($product->images)
                                                ...
                                                @foreach ($images as $image)
                                                    <div>
                                                        <img src="{{ asset('front/assets/images/fashion/product/front') }}/{{ $image }}"
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    <div class="product-count">
                                        <ul>
                                            <li>
                                                <img src="{{ asset('front') }}/assets/images/gif/fire.gif"
                                                    class="img-fluid blur-up lazyload" alt="image">
                                                <span class="p-counter">37</span>
                                                <span class="lang">orders in last 24 hours</span>
                                            </li>
                                            <li>
                                                <img src="{{ asset('front') }}/assets/images/gif/person.gif"
                                            ...
                                            <ul class="image-section">
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="{{ asset('front') }}/assets/images/fashion/product/front/5.jpg"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="{{ asset('front') }}/assets/images/fashion/product/front/6.jpg"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="{{ asset('front') }}/assets/images/fashion/product/front/7.jpg"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <ul class="product-count shipping-order">
                                        <li>
                                            <img src="{{ asset('front') }}/assets/images/gif/truck.png"
                                                class="img-fluid blur-up lazyload" alt="image">
                                        ...
                                        <div class="customer-review-box">
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="{{ asset('front') }}/assets/images/inner-page/review-image/1.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="{{ asset('front') }}/assets/images/inner-page/review-image/2.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="{{ asset('front') }}/assets/images/inner-page/review-image/3.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="{{ asset('front') }}/assets/images/inner-page/review-image/4.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    <div class="back">
                                        <a href="details.html">
                                            <img src="{{ asset('front') }}/assets/images/fashion/product/back/6.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    <div class="back">
                                        <a href="details.html">
                                            <img src="{{ asset('front') }}/assets/images/fashion/product/back/8.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    <div class="back">
                                        <a href="details.html">
                                            <img src="{{ asset('front') }}/assets/images/fashion/product/back/2.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="details.html">
                                            <img src="{{ asset('front') }}/assets/images/fashion/product/front/14.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
