...
<link id="color-link" rel="stylesheet" type="text/css" href="{{ asset('front') }}/assets/css/demo2.css">

@section('title', 'Shop Now')
@section('breadcrumb-section-h3', 'Autem Repudiandae Accusantium Blanditiis')
@section('breadcrumb-section', 'Autem Repudiandae Accusantium Blanditiis')
@section('content')
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div
                                            class="details-image-vertical black-slide rounded slick-initialized slick-slider slick-vertical">
                                            <div class="slick-list draggable" style="height: 401.25px; padding: 0px;">
                                                <div class="slick-track"
                                                    style="opacity: 1; height: 1605px; transform: translate3d(0px, -401px, 0px);">
                                                    ...
                                                    <div class="slick-slide slick-current slick-active slick-center"
                                                        data-slick-index="0" aria-hidden="false" style="width: 95px;">
                                                        <div>
                                                            <div style="width: 100%; display: inline-block;">
                                                                <img src="../assets/images/fashion/product/front/1.jpg"
                                                                    class="img-fluid blur-up lazyloaded" alt="">
                                                    ...
                                                    <div class="slick-slide slick-active" data-slick-index="1"
                                                        aria-hidden="false" style="width: 95px;">
                                                        <div>
                                                            <div style="width: 100%; display: inline-block;">
                                                                <img src="../assets/images/fashion/2.jpg"
                                                                    class="img-fluid blur-up lazyloaded" alt="">
                                                    ...
                                                    <div class="slick-slide slick-cloned slick-center" data-slick-index="4"
                                                        id="" aria-hidden="true" tabindex="-1"
                                                        style="width: 95px;">
                                                        <div>
                                                            <div style="width: 100%; display: inline-block;">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="details-image-1 ratio_asos slick-initialized slick-slider">
                                            <div class="slick-list draggable">
                                                <div class="slick-track" style="opacity: 1; width: 1900px;">
                                                    <div class="slick-slide slick-current slick-active"
                                                        data-slick-index="0" aria-hidden="false"
                                                        style="width: 475px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;">
                                                        <div>
                                                            <div style="width: 100%; display: inline-block;">
                                                                <img src="../assets/images/fashion/product/front/1.jpg"
                                                                    id="zoom_01"
                                                                    data-zoom-image="assets/images/fashion/1.jpg"
                                                                    class="img-fluid w-100 image_zoom_cls-0 blur-up lazyloaded"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="slick-slide" data-slick-index="1" aria-hidden="true"
                                                        tabindex="-1"
                                                        style="width: 475px; position: relative; left: -475px; top: 0px; z-index: 998; opacity: 0;">
                                                        <div>
                                                            <div style="width: 100%; display: inline-block;">
                                                                <img src="../assets/images/fashion/2.jpg" id="zoom_02"
                                                                    data-zoom-image="assets/images/fashion/2.jpg"
                                                                    class="img-fluid w-100 image_zoom_cls-1 blur-up lazyloaded"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="slick-slide" data-slick-index="2" aria-hidden="true"
                                                        tabindex="-1"
                                                        style="width: 475px; position: relative; left: -950px; top: 0px; z-index: 998; opacity: 0;">
                                                        <div>
                                                            <div style="width: 100%; display: inline-block;">
                                                                <img src="../assets/images/fashion/3.jpg" id="zoom_03"
                                                                    data-zoom-image="assets/images/fashion/3.jpg"
                                                                    class="img-fluid w-100 image_zoom_cls-2 blur-up lazyloaded"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="slick-slide" data-slick-index="3" aria-hidden="true"
                                                        tabindex="-1"
                                                        style="width: 475px; position: relative; left: -1425px; top: 0px; z-index: 998; opacity: 0;">
                                                        <div>
                                                            <div style="width: 100%; display: inline-block;">
                                                                <img src="../assets/images/fashion/4.jpg" id="zoom_04"
                                                                    data-zoom-image="assets/images/fashion/4.jpg"
                                                                    class="img-fluid w-100 image_zoom_cls-3 blur-up lazyloaded"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                        ...
                                        <ul>
                                            <li>
                                                <img src="../assets/images/gif/fire.gif"
                                                    class="img-fluid blur-up lazyloaded" alt="image">
                                                <span class="p-counter">37</span>
                                                <span class="lang">orders in last 24 hours</span>
                                            </li>
                                            <li>
                                                <img src="../assets/images/gif/person.gif"
                                                    class="img-fluid user_img blur-up lazyloaded" alt="image">
                                    ...
                                    <ul class="product-count shipping-order">
                                        <li>
                                            <img src="../assets/images/gif/truck.png" class="img-fluid blur-up lazyloaded"
                                                alt="image">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-lg-4">
                                            <img src="../assets/images/fashion/slider/1.jpg"
                                                class="img-fluid rounded blur-up lazyloaded" alt="">
                                        </div>
